...
has %.rules = ( 
 SA => $[{:adjust("1:00"), :at-type("w"), :dow(${:dow(7), :mindate("15")}), :letter("-"), :month(9), :time("2:00"), :years(1942..1943)}, {:adjust("0"), :at-type("w"), :dow(${:dow(7), :mindate("15")}), :letter("-"), :month(3), :time("2:00"), :years(1943..1944)}],
);
