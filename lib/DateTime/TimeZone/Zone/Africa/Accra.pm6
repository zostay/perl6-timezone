...
has %.rules = ( 
 Ghana => $[{:adjust("0:20"), :at-type("w"), :date("1"), :letter("GHST"), :month(9), :time("0:00"), :years(1936..1942)}, {:adjust("0"), :at-type("w"), :date("31"), :letter("GMT"), :month(12), :time("0:00"), :years(1936..1942)}],
);
