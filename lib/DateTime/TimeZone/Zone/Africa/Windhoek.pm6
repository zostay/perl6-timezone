...
has %.rules = ( 
 Namibia => $[{:adjust("1:00"), :at-type("w"), :dow(${:dow(7), :mindate("1")}), :letter("S"), :month(9), :time("2:00"), :years(1994..Inf)}, {:adjust("0"), :at-type("w"), :dow(${:dow(7), :mindate("1")}), :letter("-"), :month(4), :time("2:00"), :years(1995..Inf)}],
);
