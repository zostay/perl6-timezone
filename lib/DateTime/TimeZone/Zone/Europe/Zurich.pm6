...
has %.rules = ( 
 ...
 Swiss => $[{:adjust("1:00"), :at-type("w"), :dow(${:dow(1), :mindate("1")}), :letter("S"), :month(5), :time("1:00"), :years(1941..1942)}, {:adjust("0"), :at-type("w"), :dow(${:dow(1), :mindate("1")}), :letter("-"), :month(10), :time("2:00"), :years(1941..1942)}],
);
