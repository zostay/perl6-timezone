...
has %.rules = ( 
 WS => $[{:adjust("1"), :at-type("w"), :lastdow(7), :letter("D"), :month(9), :time("3:00"), :years(2012..Inf)}, {:adjust("0"), :at-type("w"), :dow(${:dow(7), :mindate("1")}), :letter("-"), :month(4), :time("4:00"), :years(2012..Inf)}],
);
