...
has %.rules = ( 
 Salv => $[{:adjust("1:00"), :at-type("w"), :dow(${:dow(7), :mindate("1")}), :letter("D"), :month(5), :time("0:00"), :years(1987..1988)}, {:adjust("0"), :at-type("w"), :lastdow(7), :letter("S"), :month(9), :time("0:00"), :years(1987..1988)}],
);
