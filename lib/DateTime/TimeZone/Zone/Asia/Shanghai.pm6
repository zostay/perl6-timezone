...
has %.rules = ( 
 ...
 Shang => $[{:adjust("1:00"), :at-type("w"), :date("3"), :letter("D"), :month(6), :time("0:00"), :years(1940..1940)}, {:adjust("0"), :at-type("w"), :date("1"), :letter("S"), :month(10), :time("0:00"), :years(1940..1941)}, {:adjust("1:00"), :at-type("w"), :date("16"), :letter("D"), :month(3), :time("0:00"), :years(1941..1941)}],
);
