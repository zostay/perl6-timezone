...
has %.rules = ( 
 ROK => $[{:adjust("1:00"), :at-type("w"), :date("15"), :letter("D"), :month(5), :time("0:00"), :years(1960..1960)}, {:adjust("0"), :at-type("w"), :date("13"), :letter("S"), :month(9), :time("0:00"), :years(1960..1960)}, {:adjust("1:00"), :at-type("w"), :dow(${:dow(7), :mindate("8")}), :letter("D"), :month(5), :time("0:00"), :years(1987..1988)}, {:adjust("0"), :at-type("w"), :dow(${:dow(7), :mindate("8")}), :letter("S"), :month(10), :time("0:00"), :years(1987..1988)}],
);
