...
has %.rules = ( 
 NBorneo => $[{:adjust("0:20"), :at-type("w"), :date("14"), :letter("TS"), :month(9), :time("0:00"), :years(1935..1941)}, {:adjust("0"), :at-type("w"), :date("14"), :letter("-"), :month(12), :time("0:00"), :years(1935..1941)}],
);
